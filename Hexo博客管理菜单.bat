...
set /p name=请输入文章名字：
call hexo new "%name%"
echo 文章创建成功，正在打开wj-markdown-editor编辑器...
start "" "D:\wj-markdown-editor\wj-markdown-editor.exe" "source\_posts\%name%.md"
echo 请在wj-markdown-editor中编辑文章，编辑完成后按任意键返回菜单。
pause >nul
goto menu
